  ...
  <div class="body">
    <div class="capaBlanca">
       <div class="centre encabezado">
          ...
          <p>Estos pequeños buscan una segunda oportunidad. ¿Eres tú su familia?</p>
       </div>
       ...
       <div v-else class="animal-grid">
          <div v-for="animal in animales" :key="animal.id" class="animal-card">
              ...
              <div class="info">
                  ...
                  <div class="acciones">
                    <router-link :to="{ path: '/contacta', query: { asunto: 'Interés en adoptar a ' + animal.nombre }}">
...
.patita-titulo { width: 3rem; margin-bottom: 0.5rem; }
...
/* Animación de carga */
.loading-container { margin: 3rem 0; }
.patita-animada {
    width: 60px;
...
.error-msg { color: #e74c3c; font-weight: bold; margin: 2rem; }
</style>