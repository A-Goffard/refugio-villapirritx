...
<template>
    <div class="body">
        ...
        <div class="capaBlanca vista-adopcion">
            ...
            <div v-else-if="animales.length === 0">
                <p>No hay animales ahora mismo.</p>
            </div>
            ...
            <div v-else class="cards-container">
                <div v-for="animal in animales" :key="animal.id" class="animal-card" @click="abrirModal(animal)">
                    ...
                    <div class="img-container">
                        <img v-if="animal.foto" :src="hacerUrlSegura(animal.foto)" :alt="animal.nombre" />
        ...
        <div v-if="animalSeleccionado" class="modal-overlay" @click.self="cerrarModal">
            <div class="modal-content">
                ...
                <div class="modal-grid">
                    <div class="modal-img">
                        <img v-if="animalSeleccionado.foto" :src="hacerUrlSegura(animalSeleccionado.foto)">
...
.vista-adopcion {
    ...
    /* Dirección columna (Arriba a abajo) */
    align-items: center;
    width: 100%;
}
...
.animal-card {
    width: 300px;
    /* Ancho fijo base, igual que tu referencia */
    background: white;
    border-radius: 15px;
    overflow: hidden;
...
.info-card {
    ...
    text-align: center;
    flex: 1;
    /* Para que todos los botones queden alineados abajo si quieres */
}
...
.patita-animada {
    width: 60px;
    animation: bote 0.8s infinite alternate;
    margin: 0 auto;
    display: block;
}
